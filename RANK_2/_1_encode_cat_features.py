...
if utils.is_tar: to_tar(tmp_data_path, 't0.joblib_dat')
...
if utils.is_tar: to_tar(tmp_data_path, 't0tv_mx.joblib_dat')
###############################################################################
...
if utils.is_tar: to_tar(tmp_data_path, 't3a.joblib_dat')